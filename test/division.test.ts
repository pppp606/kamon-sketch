...
describe("Point Division Calculations", () => {
  describe("divideTwoPoints", () => {
    ...
    it("should throw error for invalid division count", () => {
      ...
      expect(() => divideTwoPoints(pointA, pointB, 0)).toThrow(
        "Division count must be greater than 0",
      );
      expect(() => divideTwoPoints(pointA, pointB, -1)).toThrow(
        "Division count must be greater than 0",
      );
    });
...
describe("Line Division Functionality", () => {
  describe("divideLineSegment", () => {
    ...
    it("should throw error for incomplete line (no second point)", () => {
      ...
      expect(() => divideLineSegment(line, divisions)).toThrow(
    ...
    it("should throw error for invalid division count", () => {
      ...
      expect(() => divideLineSegment(line, 0)).toThrow(
        "Division count must be greater than 0",
      );
      expect(() => divideLineSegment(line, -1)).toThrow(
        "Division count must be greater than 0",
      );
    });
...
describe("CompassArc Radius Division Functionality", () => {
  describe("divideRadiusPoints", () => {
    ...
    it("should throw error for arc without radius set", () => {
      ...
      expect(() => divideRadiusPoints(arc, divisions)).toThrow(
        "Arc must have both center and radius set before division",
      );
    });
    ...
    it("should throw error for invalid division count", () => {
      ...
      expect(() => divideRadiusPoints(arc, 0)).toThrow(
        "Division count must be greater than 0",
      );
      expect(() => divideRadiusPoints(arc, -1)).toThrow(
        "Division count must be greater than 0",
      );
    });
...
describe("Division UI/Interaction System", () => {
  describe("DivisionMode", () => {
    ...
    it("should throw error for invalid element type", () => {
      ...
      expect(() => divisionMode.activate(invalidElement, 2)).toThrow(
        "Unsupported element type for division: invalid",
      );
    });
    ...
    it("should throw error for invalid divisions count", () => {
      ...
      expect(() => divisionMode.activate(element, 0)).toThrow(
        "Division count must be greater than 0",
      );
      expect(() => divisionMode.activate(element, -1)).toThrow(
        "Division count must be greater than 0",
      );
    });
